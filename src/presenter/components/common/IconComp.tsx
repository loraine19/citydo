...
export const iconMap = {
    ...
    campaign: { filled: CampaignFilled, default: Campaign },
    ...
    content_copy: { filled: ContentCopyFilled, default: ContentCopy },
    ...
    fiber_manual_record: { filled: FiberManualRecordFilled, default: FiberManualRecord },
    ...
    gavel: { filled: GavelFilled, default: Gavel },
    functions: { filled: FunctionsFilled, default: Functions },
    grid_view: { filled: GridViewFilled, default: GridView },
    group: { filled: GroupFilled, default: Group },
    group_search: { filled: GroupSearchFilled, default: GroupSearch },
    groups: { filled: GroupsFilled, default: Groups },
    heart_minus: { filled: HeartMinusFilled, default: HeartMinus },
    heart_plus: { filled: HeartPlusFilled, default: HeartPlus },
    heart_check: { filled: HeartCheckFilled, default: HeartCheck },
    home: { filled: HomeFilled, default: Home },
    how_to_vote: { filled: HowToVoteFilled, default: HowToVote },
    hourglass_bottom: { filled: HourglassBottomFilled, default: HourglassBottom },
    image: { filled: ImageFilled, default: Image },
    image_arrow_up: { filled: ImageArrowUpFilled, default: ImageArrowUp },
    install_desktop: { filled: InstallDesktopFilled, default: InstallDesktop },
    ...
    location_off: { filled: LocationOffFilled, default: LocationOff },
    lock_reset: { filled: LockResetFilled, default: LockReset },
    mail: { filled: MailFilled, default: Mail },
    manage_accounts: { filled: ManageAccountsFilled, default: ManageAccounts },
    map: { filled: MapFilled, default: Map },
    ...
    no_accounts: { filled: NoAccountsFilled, default: NoAccounts },
    ...
    person_check: { filled: PersonCheckFilled, default: PersonCheck },
    ...
    question_mark: { filled: QuestionMarkFilled, default: QuestionMark },
    radio_button_checked: { filled: RadioButtonCheckedFilled, default: RadioButtonChecked },
    radio_button_unchecked: { filled: RadioButtonUncheckedFilled, default: RadioButtonUnchecked },
    refresh: { filled: RefreshFilled, default: Refresh },
    report: { filled: ReportFilled, default: Report },
    rocket_launch: { filled: RocketLaunchFilled, default: RocketLaunch },
    save: { filled: SaveFilled, default: Save },
    save_as: { filled: SaveAsFilled, default: SaveAs },
    savings: { filled: SavingsFilled, default: Savings },
    search: { filled: SearchFilled, default: Search },
    share: { filled: ShareFilled, default: Share },
    share_location: { filled: ShareLocationFilled, default: ShareLocation },
    ...
    support_agent: { filled: SupportAgentFilled, default: SupportAgent },
    ...
    timer: { filled: TimerFilled, default: Timer },
