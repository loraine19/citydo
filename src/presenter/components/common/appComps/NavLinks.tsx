...
export const NavLinks: React.FC<NavBarProps> = ({ placement, mainPage, addFab }) => {
    ...
    const containerStyle = isBottom ? `rounded-t-[2rem] pt-3 px-3 !flex-1 md3-elevation-5 !max-w-full !border-b-0 justify-between bg-gradient-to-t from-[var(--md3-surface)] to-[25%] to-[var(--md3-primary-container)]` :
