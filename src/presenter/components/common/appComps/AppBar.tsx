...
export default function AppBar({ mainPage, listPage, detailPage, singlePage, addFab }:
    ...
    return (
        <header className={`
                ${!mainPage && 'bg-gradient-to-t from-[var(--md3-primary-container)] from-[80%] to-[var(--md3-surface)] md3-primary-container  md3-elevation-2  rounded-b-3xl mx-[1px] !w-[calc(100%-2px)]'} !sticky top-0 flex-col flex gap-2 `}>
