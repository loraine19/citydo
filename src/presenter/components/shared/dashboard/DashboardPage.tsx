...
export default function DashboardPage() {
    ...
    return (
        <main className={`
            ${navBottom ? '-mt-6  !max-h-[calc(100dvh_-_8.3rem)] lg:!max-h-[calc(100dvh_-_9.5rem)] ' : '!-mt-6 !max-h-[calc(100dvh_-_3.5rem)] lg:!max-h-[calc(100dvh_-_2rem)] '} lg:!mt-0  overflow-hidden `}
