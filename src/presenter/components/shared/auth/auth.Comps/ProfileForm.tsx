            ...
            <main>
                <div className="FormCardDiv">
                    <Card className="FormDetailGrid !grid-rows-[auto_1fr] ">
                        <CardHeader
                            className="-mt-2 !mx-0 flex flex-col w-full relative items-center justify-center max-h-fit">
                        ...
                        <CardBody className="px-6 flex flex-1 flex-col h-full gap-3 overflow-auto ">
                            <Input
